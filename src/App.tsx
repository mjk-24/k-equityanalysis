  ...
  return (
    <div className="min-h-screen bg-jpm-bg font-sans text-zinc-900">
      ...
      <Routes>
        ...
        <Route path="/privacy" element={<LegalPage title={t('footer.privacy')} date="Feb 26, 2026" />} />
        <Route path="/terms" element={<LegalPage title={t('footer.terms')} date="Feb 26, 2026" />} />
        <Route path="/disclosures" element={<LegalPage title={t('footer.disclosures')} date="Feb 26, 2026" />} />
      </Routes>
      ...
      <footer className="bg-jpm-brown text-white py-16 mt-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
            ...
            <div>
              <h4 className="font-bold mb-6 uppercase text-xs tracking-widest text-zinc-500">{t('footer.nav')}</h4>
              <ul className="space-y-4 text-sm text-zinc-300">
                <li><Link to="/" className="hover:text-white transition-colors">{t('nav.home')}</Link></li>
                <li><Link to="/analysis" className="hover:text-white transition-colors">{t('nav.analysis')}</Link></li>
                <li><Link to="/market-briefs" className="hover:text-white transition-colors">{t('nav.marketBriefs')}</Link></li>
              </ul>
            </div>
            <div>
              <h4 className="font-bold mb-6 uppercase text-xs tracking-widest text-zinc-500">{t('footer.legal')}</h4>
              <ul className="space-y-4 text-sm text-zinc-300">
                <li><Link to="/privacy" className="hover:text-white transition-colors">{t('footer.privacy')}</Link></li>
                <li><Link to="/terms" className="hover:text-white transition-colors">{t('footer.terms')}</Link></li>
                <li><Link to="/disclosures" className="hover:text-white transition-colors">{t('footer.disclosures')}</Link></li>
              </ul>
            </div>
          </div>
